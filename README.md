...
3. Open a terminal and run the following command:
    ...
    The command above will download the correct version of gradle.
...
mode | String | stmt | If the query doesn't return a value and must not log in the log file, use **stmt** otherwise use **query**. 
